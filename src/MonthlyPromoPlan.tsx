  ...
  return (
    <div className="App">
      ...
      <main className="content">
        ...
        <h1>Upload Monthly Promo Plan File</h1>
        <br></br>
        <p>Please select and upload your monthly promo plan file. <br></br>(Excel only)</p>
...
export default MonthlyPromoPlan;
