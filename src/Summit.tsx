  ...
  const handleUpload = () => {
    ...
    reader.onload = (e) => {
      try {
        ...
        // Define required tab names for Summit file
        const requiredTabs = ['Sheet2'];
  ...
  return (
    <div className="App">
      ...
      <main className="content">
        ...
        <h1>Upload Monthly Summit File</h1>
          <br></br>
        <p>Please select and upload your monthly summit file. <br></br>(Excel only)</p>
